...
export function UnscheduledBucket({ jobs, onSelectJob, onUnschedule, collapsed, onToggleCollapse }: UnscheduledBucketProps) {
  ...
  if (collapsed) {
    return (
      <div className="flex items-center justify-between px-4 py-2.5 bg-gray-100 rounded-lg mb-3 shadow-inner shrink-0">
        <div className="flex items-center gap-2">
          <span className="text-sm font-bold uppercase tracking-wider text-gray-500">Unscheduled Jobs</span>
        ...
        <button
          ...
          className="text-xs font-bold text-gray-400 hover:text-primary-600 flex items-center gap-1 transition-colors"
        >
          Show
  ...
  return (
    <div
      className="unscheduled-bucket p-4 bg-gray-100 rounded-lg mb-3 shadow-inner transition-all shrink-0"
      onDragOver={(e) => {
        e.preventDefault();
